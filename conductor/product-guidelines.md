# Product Guidelines - $4 Portfolio

## Content Tone and Voice
- **Professional and Concise:** All descriptions should be technically accurate and brief. Avoid fluff and focus on the technical substance of the work.
...
## Visual Identity
- **Minimalist Aesthetic:** Adhere to the `jekyll-theme-minimal` style. The layout should remain uncluttered to keep the focus on the content.
- **Markdown Purity:** Use standard Markdown for all formatting to ensure maximum compatibility and ease of maintenance.
